...
class login : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val register: TextView = view.findViewById(R.id.textView9)
        register.setOnClickListener{
            navcon.navigate(R.id.action_login_to_register)
        }
        val logi = view.findViewById<TextInputEditText>(R.id.email)
        val passwor = view.findViewById<TextInputEditText>(R.id.password)
        val button =view.findViewById<Button>(R.id.button101)
